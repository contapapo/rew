        ...
        <div class="col-lg-10">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <h3 class="panel-title"><i class="fa fa-table" aria-hidden="true"></i> <?php echo e("ERP-CH Monthly"); ?></h3>
                   <div class="btn-group">
                   <?php echo Form::open(['url' => 'erpmonthly', 'files' => true]); ?>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table id="table-users" class="tablesorter table table-bordered table-hover table-striped" >
                            <thead>
                            <tr>
                                <th  data-column-name=""><?php echo e(("")); ?> <i class="fa fa-sort"></i></th>
                                ...
                                <th class="sorter-metatext" data-column-name=""><?php echo e(("S00")); ?> <i class="fa fa-sort"></i></th>
                                <th class="sorter-metatext" data-column-name=""><?php echo e(("AP")); ?> <i class="fa fa-sort"></i></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                              <tr>
                               ...
                               <td><?php echo e($user->s00); ?></td>
                               <td><?php echo e($user->ap); ?></td>
                              </tr>
